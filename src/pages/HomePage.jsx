                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        Premium quality products from verified farmers ({totalProducts} products)
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            {loadingProducts ? (
                                ...
                                <div className="p-12 flex flex-col items-center justify-center text-center">
                                    ...
                                    <p className="text-sm text-gray-500 max-w-lg">
                                        We're working with farmers to bring more items to the marketplace.
                                    </p>
                                </div>
                            ) : (
                                <>
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <div className="text-right">
                                                            <div className={`text-xs font-medium ${product.stock_quantity > 0 ? 'text-green-600' : 'text-red-500'}`}>
                                                    ...
                                                    <div className="flex items-center gap-2 text-xs text-gray-500">
                                                        <span>{product.stock_quantity} {product.unit?.symbol || 'units'} available</span>
                                                    </div>
