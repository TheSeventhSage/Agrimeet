        ...
        <DashboardLayout>
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className={`rounded-xl shadow-sm border p-6 ${isAdmin ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}>
                    ...
                    <div className={`rounded-xl shadow-sm border p-6 ${isSeller ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200'}`}>
                        <div className="flex items-center gap-3">
                            {isSeller ? (
                    ...
                    <div className={`rounded-xl shadow-sm border p-6 ${tokens ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}>
                        <div className="flex items-center gap-3">
                            {tokens ? (
                                <CheckCircle className="w-8 h-8 text-green-600" />
                            ) : (
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p className="text-gray-900 font-mono bg-gray-50 p-2 rounded mt-1">
                                    {userData?.role || 'null'}
                                </p>
                            </div>
                            <div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div className="space-y-2">
                        <div>
                            ...
                            <p className="text-gray-900 font-mono bg-gray-50 p-2 rounded mt-1 text-xs break-all">
                                {tokens?.access_token ? 
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-gray-700 space-y-2">
                                    ...
                                    <pre className="bg-white p-3 rounded border border-yellow-200 mt-2 text-xs overflow-x-auto">
{`{
  "access_token": "...",
