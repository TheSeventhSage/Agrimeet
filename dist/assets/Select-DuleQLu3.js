import{j as e}from"./index-C7G52Pl0.js";const m=({label:a,options:c=[],value:n,onChange:o,error:s,required:r=!1,disabled:t=!1,placeholder:d="Select an option",className:i="",...x})=>e.jsxs("div",{className:"space-y-1",children:[a&&e.jsxs("label",{className:"block text-sm font-medium text-gray-700",children:[a,r&&e.jsx("span",{className:"text-red-500 ml-1",children:"*"})]}),e.jsxs("select",{value:n,onChange:o,disabled:t,required:r,className:`
